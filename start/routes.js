...
Route.put('/debit/account/:accountNumber/transaction/:id','StaffController.debit').middleware(['auth','admin'])
Route.put('/credit/account/:accountNumber/transaction/:id','StaffController.credit').middleware(['auth','admin'])
